...
custom_font = font.Font(family="Helvetica", size=12, weight="bold")
btn_boletim = Button(frame2, text="Boletim", font=custom_font, bg= "white", borderwidth=0, highlightthickness=0, width=8, height=1, command=boletim)
custom_font = font.Font(family="Helvetica", size=12, weight="bold")
btn_trocar_senha = Button(frame2, text="Trocar Senha", font=custom_font, bg= "white", borderwidth=0, highlightthickness=0, width=13, height=1, command=trocar_senha)
custom_font = font.Font(family="Helvetica", size=12, weight="bold")
...
# Salvando e posicionando os botões dentro do frame2
btn_matricula.place(x=230, y=17)
btn_notas.place(x=420, y=17)
btn_boletim.place(x=615, y=17)
btn_trocar_senha.place(x=1050, y=17)
btn_sair.place(x=1260, y=17)
...
btn_cadastro.place(x=810, y=17)
# Alterando o estilo do botão de lista suspensa
btn_cadastro.config(bg="white", fg="black", borderwidth=0, highlightthickness=0,font=("Arial", 12, "bold"),width=10,height=1)
